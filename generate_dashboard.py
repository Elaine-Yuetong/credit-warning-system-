...
<main>
  ...
  <section class="card">
    ...
    <canvas id="cohenChart" height="200"></canvas>
...
function renderCohen(){
  ...
  new Chart(document.getElementById("cohenChart"),{type:'bar',
    ...
    options:{indexAxis:'y',plugins:{legend:{display:false},
      ...
      scales:{x:{grid:{color:'#eef0f2'},ticks:{font:{family:'monospace',size:11}},title:{display:true,text:"Cohen's d (distressed vs healthy, [0,4] ordinal)"}},
        y:{grid:{display:false},ticks:{font:{family:'monospace',size:10.5}}}},
